...
namespace UniversalChat.Interface
{
    ...
    public static class IRoom_PayloadTable
    {
        ...
        public class Enter_Invoke : IInterfacedPayload, IAsyncInvokable
        {
            ...
            public UniversalChat.Interface.RoomObserver observer;
        ...
        {
            public UniversalChat.Interface.RoomInfo v;
...
#region UniversalChat.Interface.IRoomDirectory
...
namespace UniversalChat.Interface
{
    ...
    public static class IRoomDirectory_PayloadTable
    {
        ...
        public class GetOrCreateRoom_Invoke : IInterfacedPayload, IAsyncInvokable
        {
            ...
            public async Task<IValueGetable> InvokeAsync(object target)
            {
                ...
                return (IValueGetable)(new GetOrCreateRoom_Return { v = (UniversalChat.Interface.RoomRef)__v });
            }
        }

        public class GetOrCreateRoom_Return : IInterfacedPayload, IValueGetable
        {
            public UniversalChat.Interface.RoomRef v;
    ...
    public class RoomDirectoryRef : InterfacedActorRef, IRoomDirectory, IRoomDirectory_NoReply
    {
        ...
        public Task<UniversalChat.Interface.IRoom> GetOrCreateRoom(System.String name)
        {
            var requestMessage = new RequestMessage
            {
                InvokePayload = new IRoomDirectory_PayloadTable.GetOrCreateRoom_Invoke { name = name }
            };
            return SendRequestAndReceive<UniversalChat.Interface.IRoom>(requestMessage);
        }
...
#region UniversalChat.Interface.IRoomDirectoryWorker
...
namespace UniversalChat.Interface
{
    ...
    public static class IRoomDirectoryWorker_PayloadTable
    {
        ...
        public class CreateRoom_Invoke : IInterfacedPayload, IAsyncInvokable
        {
            ...
            public async Task<IValueGetable> InvokeAsync(object target)
            {
                ...
                return (IValueGetable)(new CreateRoom_Return { v = (UniversalChat.Interface.RoomRef)__v });
            }
        }
    ...
    public class RoomDirectoryWorkerRef : InterfacedActorRef, IRoomDirectoryWorker, IRoomDirectoryWorker_NoReply
    {
        ...
        public Task<UniversalChat.Interface.IRoom> CreateRoom(System.String name)
        {
            var requestMessage = new RequestMessage
            {
...
#region UniversalChat.Interface.IUserDirectory
...
namespace UniversalChat.Interface
{
    ...
    public static class IUserDirectory_PayloadTable
    {
        ...
        public class GetUser_Invoke : IInterfacedPayload, IAsyncInvokable
        {
            ...
            public async Task<IValueGetable> InvokeAsync(object target)
            {
                ...
                return (IValueGetable)(new GetUser_Return { v = (UniversalChat.Interface.UserRef)__v });
            }
        }

        public class GetUser_Return : IInterfacedPayload, IValueGetable
        {
            public UniversalChat.Interface.UserRef v;
        ...
        {
            public System.String userId;
            public UniversalChat.Interface.UserRef user;
    ...
    public interface IUserDirectory_NoReply
    {
        ...
        void RegisterUser(System.String userId, UniversalChat.Interface.IUser user);
    ...
    public class UserDirectoryRef : InterfacedActorRef, IUserDirectory, IUserDirectory_NoReply
    {
        ...
        public Task<UniversalChat.Interface.IUser> GetUser(System.String userId)
        {
            var requestMessage = new RequestMessage
            {
                InvokePayload = new IUserDirectory_PayloadTable.GetUser_Invoke { userId = userId }
            };
            return SendRequestAndReceive<UniversalChat.Interface.IUser>(requestMessage);
        }

        public Task RegisterUser(System.String userId, UniversalChat.Interface.IUser user)
        {
            var requestMessage = new RequestMessage
            {
                InvokePayload = new IUserDirectory_PayloadTable.RegisterUser_Invoke { userId = userId, user = (UniversalChat.Interface.UserRef)user }
            };
            return SendRequestAndWait(requestMessage);
        }
        ...
        void IUserDirectory_NoReply.RegisterUser(System.String userId, UniversalChat.Interface.IUser user)
        {
            var requestMessage = new RequestMessage
            {
                InvokePayload = new IUserDirectory_PayloadTable.RegisterUser_Invoke { userId = userId, user = (UniversalChat.Interface.UserRef)user }
